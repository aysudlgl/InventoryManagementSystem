...
public class inventory {
	...
	public String toString() {
		return "inventory [id=" + id + ", itemNumber=" + itemNumber + ", itemGroup=" + itemGroup + ", itemName="
				+ itemName + ", quantity=" + quantity + ", price=" + price + ", vendor=" + vendor + ", description="
				+ description + ", inventoryStatus=" + inventoryStatus + ", minimumOrder=" + minimumOrder + "]";
	}
